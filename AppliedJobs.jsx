...
export default function AppliedJobs() {
  ...
  useEffect(() => {
    document.title = 'Applied Jobs – jobhunter.ai'
  }, [])
  ...
  const formatSalary = (val) => {
    if (!val || !Number.isFinite(val)) return 'Not specified'
        ...
        >
          <div style={{ minWidth: 0 }}>
            ...
            <p data-slot="card-description">
              {company} · {job.location} {job.type ? `• ${job.type}` : ''}
            </p>
            ...
            >
              ...
              <div className="salary-range">Salary: {salaryText}</div>
